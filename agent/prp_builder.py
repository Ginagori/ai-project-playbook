"""
PRP Builder — Context-Aware Executable Specifications
...
No LLM calls — uses structured text parsing on the PRD and CLAUDE.md
...
> **Generated by AI Project Playbook — Nivanta AI**
...
3. Implement features IN ORDER (Section 3) — dependencies are already resolved
...
**Rules:**
- Follow CLAUDE.md patterns exactly — do not invent new patterns
